...
if (!empty($_POST)) {
  ...
  $erro = 0;
  $query1 = "INSERT INTO cliente VALUES (null,'$nome',$cpf,$rg,'$dt')";

  $consulta = "select cod_cli from cliente order by cod_cli desc limit 1";
  $resultado = mysqli_query($conexao,$consulta);
    if (mysqli_num_rows($resultado)<>0){
         ...
         $id2 = $id + 1;
   $query2 = "INSERT INTO endereco (logradouro,numero,cep,complemento,cod_cliente) VALUES ('$lg','$nm',$cep,'$cpm',$id2)";


   $query3= "INSERT INTO telefone (telefone,celular,cod_cliente) VALUES ('$tf',$cl,$id2)";
...
<center><br><br><br>
<form id="cont" class="rounded" method="post" action="frm_cliente.php" name="form">
			<h2>Cadastro de Cliente</h3>
