...
FROM
    ...
    endereco ON  fornecedor.cod_forn = endereco.cod_fornecedor ;";
		...
		echo '<h2>Cadastro de Fornecedor</h3><br>';
...
echo'<tr>';
  ...
  echo '<td>'. $dados[9] . '</td>';
	...
	echo "<td><center><a href='alt_fornecedor.php?cod=$dados[0]'>$x</a></td>";
  echo "<td><center><a href='ext_fornecedor.php?cod=$dados[0]'onclick=\"return confirm('Tem certeza que deseja deletar esse registro?');\">$y</a></td>";
	echo '</tr>';
