...
SELECT
	...
	FROM
		...
		echo '<h2>Cadastro de Contas</h3><br>';
...
echo'<tr>';
  ...
  echo '<td>'. $dados[5] . '</td>';
	...
	echo "<td><center><a href='alt_contas.php?cod=$dados[0]'>$x</a></td>";
  echo "<td><center><a href='ext_contas.php?cod=$dados[0]'onclick=\"return confirm('Tem certeza que deseja deletar esse registro?');\">$y</a></td>";
	echo '</tr>';
