...
if (!empty($_POST)) {
  ...
  $erro = 0;
  $query1 = "INSERT INTO contador VALUES (null,'$nome',$cnpj,$ie)";

  $consulta = "select cod_cont from contador order by cod_cont desc limit 1";
  $resultado = mysqli_query($conexao,$consulta);
    if (mysqli_num_rows($resultado)<>0){
         ...
         $id2 = $id + 1;
   $query2 = "INSERT INTO endereco (logradouro,numero,cep,complemento,cod_contador) VALUES ('$lg','$nm',$cep,'$cpm',$id2)";


   $query3= "INSERT INTO telefone (telefone,celular,cod_contador) VALUES ('$tf',$cl,$id2  )";
...
<form id="cont" class="rounded" method="post" action="frm_contador.php" name="form">
