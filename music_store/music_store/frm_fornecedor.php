...
if (!empty($_POST)) {
  ...
  $resultado = mysqli_query($conexao,$consulta);
    if (mysqli_num_rows($resultado)<>0){
         ...
         $id2 = $id + 1;
   $query2 = "INSERT INTO endereco (logradouro,numero,cep,complemento,cod_fornecedor) VALUES ('$lg','$nm',$cep,'$cpm',$id2)";


   $query3= "INSERT INTO telefone (telefone,celular,cod_fornecedor) VALUES ('$tf',$cl,$id2)";
...
<form id="cont" class="rounded" method="post" action="frm_fornecedor.php" name="form">
